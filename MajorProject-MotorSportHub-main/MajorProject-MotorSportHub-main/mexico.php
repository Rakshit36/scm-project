...
<div class="menu-toggle"><i class="fa fa-bars" aria-hidden="true"></i></div>
   ...
   <div class="container">
       <div class="heading">
          <h2>Rally Mexico 2020</h2>
          <p>Images rights belong to: <a href = "https://www.rallymexico.com/gallery-rally/?galid=72157713398524081&galname=Friday%202020">Rally Mexico Gallery</a></p>
          </div>
        <div class="row">
        ...
        Displays the images within the cards loaded using bootstrap-->
         <?php 
         //SQL which selects the required images and the captions from the table mexico20
         $sql = 'SELECT `img_ID`, `Caption`, `img` FROM `mexico20` ';
         //the query is loaded to mexico results so that the full set can be saved into this variable
         $mexicoresults = mysqli_query($conn, $sql); 
         //while loop which will load the results from mexico results into the cards as long as there 
        // are results availble.
         while ($record = mysqli_fetch_assoc($mexicoresults)){
           //image variables which load the path to the image within them.
           $imgThumBurl = 'images/'.$record["img"];
           $imgURL = 'images/'.$record["img"];
         ?>
          <div class="col-md-4">
            <!--cards are used to display the data. -->
            <div class ="card border-0 transform-on-hover"> 
              <!--Php has been used to load the image to the link so that when it is clicked 
            will load the correct data and this makes use of the fancybox library to do so-->
            <a href = "<?php echo $imgURL; ?>" data-fancybox="gallery" data-caption="<?php echo $record['Caption']; ?>">
            <!--Images are loaded to the card at the top and the caption is the card title in the card body-->
       ...
       <!--Images References -->
               <!-- Rally México. 2020. Gallery-Rally. [online] Available at: <https://www.rallymexico.com/gallery-rally/?galid=72157713398524081&galname=Friday%202020> [Accessed 15 March 2020].-->
               <!--Rally México. 2020. Gallery-Rally. [online] Available at: <https://www.rallymexico.com/gallery-rally/?galid=72157713399689438&galname=Saturday%202020> [Accessed 15 March 2020].-->
            </div>


   </section>
      <footer class="footer">
     <p>Motorsport Hub &copy; 2020. <br />Images credit:<a href = "https://www.rallymexico.com/gallery-rally/?galid=72157713398524081&galname=Friday%202020">Rally Mexico Gallery</p>
		</footer> 
    <!-- Optional JavaScript -->
