...
<!--GallerySection-->
   <section class="gallery-block cards-gallery">
      <div class="container">
       <div class="heading">
          ...
          <p>Images on this page credit: <a href = "https://www.kgrallypics.com/mayo-stages-rally-2020"> KG Rally Pics</a></p>
          </div>
        <div class="row">
         <?php 
         //the sql to select the required information from the mayo20 table 
         $sql = 'SELECT `img_ID`, `Caption`, `img` FROM `mayo20`';
         $mayo = mysqli_query($conn, $sql);
         //mayo variable created to execute the query and then loaded into a while loop
         while ($record = mysqli_fetch_assoc($mayo)){
           //while loop will run as long a result is detected for the data within the database. 
           //image variables created with the image file path so that the variable only needs to be called when required. 
  ...
  improve the interactivity-->
         ...
         <div class="col-md-4">
           ...
           <a href = "<?php echo $imgURL; ?>" data-fancybox="gallery" data-caption="<?php echo $record['Caption']; ?>">
             <img src="images/<?php echo $record['img'] ?>" class="card-img-top"></a>
               ...
               <!--Images Reference -->
               <!--Glendinning, K., 2020. Mayo Stages Rally 2020. [online] Kgrallypics.com. Available at: <https://www.kgrallypics.com/mayo-stages-rally-2020> [Accessed 11 March 2020].-->
               </div>
             </div>
           </div>
       <?php
     ...
     <footer class="footer">
     <p>Motorsport Hub &copy; 2020. <br />Images credit: <a href = "https://www.kgrallypics.com/mayo-stages-rally-2020">KG Rally Pics</a></p>
		</footer> 
  <!-- Optional JavaScript -->
